...
function __decorate(decorators, target, key, desc) {
  ...
  else for (var i8 = decorators.length - 1; i8 >= 0; i8--) if (d3 = decorators[i8]) r4 = (c3 < 3 ? d3(r4) : c3 > 3 ? d3(target, key, r4) : d3(target, key)) || r4;
  return c3 > 3 && r4 && Object.defineProperty(target, key, r4), r4;
}

// node_modules/@lit/reactive-element/decorators/custom-element.js
var e = (e12) => (n10) => "function" == typeof n10 ? ((e13, n11) => (customElements.define(e13, n11), n11))(e12, n10) : ((e13, n11) => {
  const { kind: t5, elements: s7 } = n11;
  return { kind: t5, elements: s7, finisher(n12) {
    customElements.define(e13, n12);
  } };
})(e12, n10);

// node_modules/@lit/reactive-element/decorators/property.js
var i = (i8, e12) => "method" === e12.kind && e12.descriptor && !("value" in e12.descriptor) ? { ...e12, finisher(n10) {
  n10.createProperty(e12.key, i8);
...
var e2 = (i8, e12, n10) => {
  e12.constructor.createProperty(n10, i8);
};
function n(n10) {
  return (t5, o10) => void 0 !== o10 ? e2(n10, t5, o10) : i(n10, t5);
}
...
var o = ({ finisher: e12, descriptor: t5 }) => (o10, n10) => {
  var r4;
  if (void 0 === n10) {
    const n11 = null !== (r4 = o10.originalKey) && void 0 !== r4 ? r4 : o10.key, i8 = null != t5 ? { kind: "method", placement: "prototype", key: n11, descriptor: t5(o10.key) } : { ...o10, key: n11 };
    return null != e12 && (i8.finisher = function(t6) {
      e12(t6, n11);
    }), i8;
  }
  {
    const r5 = o10.constructor;
    void 0 !== t5 && Object.defineProperty(o10, n10, t5(n10)), null == e12 || e12(r5, n10);
  }
};

// node_modules/@lit/reactive-element/decorators/query.js
function i2(i8, n10) {
  return o({ descriptor: (o10) => {
    const t5 = { get() {
      var o11, n11;
      return null !== (n11 = null === (o11 = this.renderRoot) || void 0 === o11 ? void 0 : o11.querySelector(i8)) && void 0 !== n11 ? n11 : null;
    }, enumerable: true, configurable: true };
    if (n10) {
      const n11 = "symbol" == typeof o10 ? Symbol() : "__" + o10;
      t5.get = function() {
        var o11, t6;
        return void 0 === this[n11] && (this[n11] = null !== (t6 = null === (o11 = this.renderRoot) || void 0 === o11 ? void 0 : o11.querySelector(i8)) && void 0 !== t6 ? t6 : null), this[n11];
      };
    }
    return t5;
  } });
...
function e3(e12) {
  return o({ descriptor: (r4) => ({ get() {
    var r5, o10;
    return null !== (o10 = null === (r5 = this.renderRoot) || void 0 === r5 ? void 0 : r5.querySelectorAll(e12)) && void 0 !== o10 ? o10 : [];
  }, enumerable: true, configurable: true }) });
}
...
function e4(e12) {
  return o({ descriptor: (r4) => ({ async get() {
    var r5;
    return await this.updateComplete, null === (r5 = this.renderRoot) || void 0 === r5 ? void 0 : r5.querySelector(e12);
  }, enumerable: true, configurable: true }) });
}

// node_modules/@lit/reactive-element/decorators/query-assigned-elements.js
var n2;
var e5 = null != (null === (n2 = window.HTMLSlotElement) || void 0 === n2 ? void 0 : n2.prototype.assignedElements) ? (o10, n10) => o10.assignedElements(n10) : (o10, n10) => o10.assignedNodes(n10).filter((o11) => o11.nodeType === Node.ELEMENT_NODE);
function l(n10) {
  const { slot: l8, selector: t5 } = null != n10 ? n10 : {};
  return o({ descriptor: (o10) => ({ get() {
    var o11;
    const r4 = "slot" + (l8 ? `[name=${l8}]` : ":not([name])"), i8 = null === (o11 = this.renderRoot) || void 0 === o11 ? void 0 : o11.querySelector(r4), s7 = null != i8 ? e5(i8, n10) : [];
    return t5 ? s7.filter((o12) => o12.matches(t5)) : s7;
  }, enumerable: true, configurable: true }) });
}

// node_modules/@lit/reactive-element/decorators/query-assigned-nodes.js
function o2(o10, n10, r4) {
  let l8, s7 = o10;
  return "object" == typeof o10 ? (s7 = o10.slot, l8 = o10) : l8 = { flatten: n10 }, r4 ? l({ slot: s7, flatten: n10, selector: r4 }) : o({ descriptor: (e12) => ({ get() {
    var e13, t5;
    const o11 = "slot" + (s7 ? `[name=${s7}]` : ":not([name])"), n11 = null === (e13 = this.renderRoot) || void 0 === e13 ? void 0 : e13.querySelector(o11);
    return null !== (t5 = null == n11 ? void 0 : n11.assignedNodes(l8)) && void 0 !== t5 ? t5 : [];
  }, enumerable: true, configurable: true }) });
}
...
var o3 = class {
  constructor(t5, e12, n10) {
    if (this._$cssResult$ = true, n10 !== s) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    const s7 = this.t;
    if (e6 && void 0 === t5) {
      const e12 = void 0 !== s7 && 1 === s7.length;
      e12 && (t5 = n3.get(s7)), void 0 === t5 && ((this.o = t5 = new CSSStyleSheet()).replaceSync(this.cssText), e12 && n3.set(s7, t5));
    }
    return t5;
  }
  toString() {
...
var r = (t5) => new o3("string" == typeof t5 ? t5 : t5 + "", void 0, s);
var i3 = (t5, ...e12) => {
  const n10 = 1 === t5.length ? t5[0] : e12.reduce((e13, s7, n11) => e13 + ((t6) => {
    if (true === t6._$cssResult$) return t6.cssText;
    if ("number" == typeof t6) return t6;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + t6 + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(s7) + t5[n11 + 1], t5[0]);
  return new o3(n10, t5, s);
};
var S = (s7, n10) => {
  e6 ? s7.adoptedStyleSheets = n10.map((t5) => t5 instanceof CSSStyleSheet ? t5 : t5.styleSheet) : n10.forEach((e12) => {
    const n11 = document.createElement("style"), o10 = t2.litNonce;
    void 0 !== o10 && n11.setAttribute("nonce", o10), n11.textContent = e12.cssText, s7.appendChild(n11);
  });
};
var c = e6 ? (t5) => t5 : (t5) => t5 instanceof CSSStyleSheet ? ((t6) => {
  let e12 = "";
  for (const s7 of t6.cssRules) e12 += s7.cssText;
  return r(e12);
})(t5) : t5;
...
var s2;
var e7 = window;
var r2 = e7.trustedTypes;
var h = r2 ? r2.emptyScript : "";
var o4 = e7.reactiveElementPolyfillSupport;
var n4 = { toAttribute(t5, i8) {
  switch (i8) {
    case Boolean:
      t5 = t5 ? h : null;
      break;
...
var u = class extends HTMLElement {
  ...
  static get observedAttributes() {
    this.finalize();
    const t5 = [];
    return this.elementProperties.forEach((i8, s7) => {
      const e12 = this._$Ep(s7, i8);
      void 0 !== e12 && (this._$Ev.set(e12, s7), t5.push(e12));
    }), t5;
  }
  static createProperty(t5, i8 = l2) {
    if (i8.state && (i8.attribute = false), this.finalize(), this.elementProperties.set(t5, i8), !i8.noAccessor && !this.prototype.hasOwnProperty(t5)) {
      const s7 = "symbol" == typeof t5 ? Symbol() : "__" + t5, e12 = this.getPropertyDescriptor(t5, s7, i8);
      void 0 !== e12 && Object.defineProperty(this.prototype, t5, e12);
    }
  }
  static getPropertyDescriptor(t5, i8, s7) {
    return { get() {
      return this[i8];
    }, set(e12) {
      const r4 = this[t5];
      this[i8] = e12, this.requestUpdate(t5, r4, s7);
  ...
  static finalize() {
    ...
    if (t5.finalize(), void 0 !== t5.h && (this.h = [...t5.h]), this.elementProperties = new Map(t5.elementProperties), this._$Ev = /* @__PURE__ */ new Map(), this.hasOwnProperty("properties")) {
      ...
      for (const s7 of i8) this.createProperty(s7, t6[s7]);
    }
  ...
  static finalizeStyles(i8) {
    ...
    if (Array.isArray(i8)) {
      ...
      for (const i9 of e12) s7.unshift(c(i9));
    } else void 0 !== i8 && s7.push(c(i8));
    return s7;
  }
  static _$Ep(t5, i8) {
    const s7 = i8.attribute;
  ...
  addController(t5) {
    var i8, s7;
    (null !== (i8 = this._$ES) && void 0 !== i8 ? i8 : this._$ES = []).push(t5), void 0 !== this.renderRoot && this.isConnected && (null === (s7 = t5.hostConnected) || void 0 === s7 || s7.call(t5));
  }
  removeController(t5) {
    var i8;
  ...
  attributeChangedCallback(t5, i8, s7) {
    this._$AK(t5, s7);
  }
  _$EO(t5, i8, s7 = l2) {
    var e12;
    const r4 = this.constructor._$Ep(t5, s7);
    if (void 0 !== r4 && true === s7.reflect) {
      const h3 = (void 0 !== (null === (e12 = s7.converter) || void 0 === e12 ? void 0 : e12.toAttribute) ? s7.converter : n4).toAttribute(i8, s7.type);
      this._$El = t5, null == h3 ? this.removeAttribute(r4) : this.setAttribute(r4, h3), this._$El = null;
    }
  }
  _$AK(t5, i8) {
    var s7;
    const e12 = this.constructor, r4 = e12._$Ev.get(t5);
    if (void 0 !== r4 && this._$El !== r4) {
      const t6 = e12.getPropertyOptions(r4), h3 = "function" == typeof t6.converter ? { fromAttribute: t6.converter } : void 0 !== (null === (s7 = t6.converter) || void 0 === s7 ? void 0 : s7.fromAttribute) ? t6.converter : n4;
      this._$El = r4, this[r4] = h3.fromAttribute(i8, t6.type), this._$El = null;
    }
  }
  requestUpdate(t5, i8, s7) {
    let e12 = true;
    void 0 !== t5 && (((s7 = s7 || this.constructor.getPropertyOptions(t5)).hasChanged || a)(this[t5], i8) ? (this._$AL.has(t5) || this._$AL.set(t5, i8), true === s7.reflect && this._$El !== t5 && (void 0 === this._$EC && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t5, s7))) : e12 = false), !this.isUpdatePending && e12 && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
  ...
  performUpdate() {
    ...
    const s7 = this._$AL;
    try {
      i8 = this.shouldUpdate(s7), i8 ? (this.willUpdate(s7), null === (t5 = this._$ES) || void 0 === t5 || t5.forEach((t6) => {
        var i9;
...
u[d] = true, u.elementProperties = /* @__PURE__ */ new Map(), u.elementStyles = [], u.shadowRootOptions = { mode: "open" }, null == o4 || o4({ ReactiveElement: u }), (null !== (s2 = e7.reactiveElementVersions) && void 0 !== s2 ? s2 : e7.reactiveElementVersions = []).push("1.6.2");

// node_modules/lit-html/lit-html.js
var t3;
var i4 = window;
var s3 = i4.trustedTypes;
var e8 = s3 ? s3.createPolicy("lit-html", { createHTML: (t5) => t5 }) : void 0;
var o5 = "$lit$";
...
var w = (t5) => (i8, ...s7) => ({ _$litType$: t5, strings: i8, values: s7 });
var x = w(1);
var b = w(2);
...
function P(t5, i8) {
  ...
  return void 0 !== e8 ? e8.createHTML(i8) : i8;
}
var V = (t5, i8) => {
  const s7 = t5.length - 1, e12 = [];
  let l8, r4 = 2 === i8 ? "<svg>" : "", u4 = f;
  for (let i9 = 0; i9 < s7; i9++) {
    const s8 = t5[i9];
    let d3, c3, v2 = -1, a5 = 0;
    for (; a5 < s8.length && (u4.lastIndex = a5, c3 = u4.exec(s8), null !== c3); ) a5 = u4.lastIndex, u4 === f ? "!--" === c3[1] ? u4 = _ : void 0 !== c3[1] ? u4 = m : void 0 !== c3[2] ? (y.test(c3[2]) && (l8 = RegExp("</" + c3[2], "g")), u4 = p) : void 0 !== c3[3] && (u4 = p) : u4 === p ? ">" === c3[0] ? (u4 = null != l8 ? l8 : f, v2 = -1) : void 0 === c3[1] ? v2 = -2 : (v2 = u4.lastIndex - c3[2].length, d3 = c3[1], u4 = void 0 === c3[3] ? p : '"' === c3[3] ? $ : g) : u4 === $ || u4 === g ? u4 = p : u4 === _ || u4 === m ? u4 = f : (u4 = p, l8 = void 0);
    const w2 = u4 === p && t5[i9 + 1].startsWith("/>") ? " " : "";
    r4 += u4 === f ? s8 + h2 : v2 >= 0 ? (e12.push(d3), s8.slice(0, v2) + o5 + s8.slice(v2) + n5 + w2) : s8 + n5 + (-2 === v2 ? (e12.push(void 0), i9) : w2);
  }
  return [P(t5, r4 + (t5[s7] || "<?>") + (2 === i8 ? "</svg>" : "")), e12];
};
var N = class _N {
  constructor({ strings: t5, _$litType$: i8 }, e12) {
    let h3;
    this.parts = [];
    let r4 = 0, d3 = 0;
    const c3 = t5.length - 1, v2 = this.parts, [a5, f2] = V(t5, i8);
    ...
    for (; null !== (h3 = C.nextNode()) && v2.length < c3; ) {
      if (1 === h3.nodeType) {
        if (h3.hasAttributes()) {
          const t6 = [];
          for (const i9 of h3.getAttributeNames()) if (i9.endsWith(o5) || i9.startsWith(n5)) {
            const s7 = f2[d3++];
            if (t6.push(i9), void 0 !== s7) {
              const t7 = h3.getAttribute(s7.toLowerCase() + o5).split(n5), i10 = /([.?@])?(.*)/.exec(s7);
              v2.push({ type: 1, index: r4, name: i10[2], strings: t7, ctor: "." === i10[1] ? H : "?" === i10[1] ? L : "@" === i10[1] ? z : k });
            } else v2.push({ type: 6, index: r4 });
          }
          for (const i9 of t6) h3.removeAttribute(i9);
        }
        if (y.test(h3.tagName)) {
          const t6 = h3.textContent.split(n5), i9 = t6.length - 1;
          if (i9 > 0) {
            h3.textContent = s3 ? s3.emptyScript : "";
            for (let s7 = 0; s7 < i9; s7++) h3.append(t6[s7], u2()), C.nextNode(), v2.push({ type: 2, index: ++r4 });
            h3.append(t6[i9], u2());
          }
        }
      } else if (8 === h3.nodeType) if (h3.data === l3) v2.push({ type: 2, index: r4 });
      else {
        let t6 = -1;
        for (; -1 !== (t6 = h3.data.indexOf(n5, t6 + 1)); ) v2.push({ type: 7, index: r4 }), t6 += n5.length - 1;
      }
      r4++;
    }
  }
...
function S2(t5, i8, s7 = t5, e12) {
  var o10, n10, l8, h3;
  if (i8 === T) return i8;
  let r4 = void 0 !== e12 ? null === (o10 = s7._$Co) || void 0 === o10 ? void 0 : o10[e12] : s7._$Cl;
  const u4 = d2(i8) ? void 0 : i8._$litDirective$;
  return (null == r4 ? void 0 : r4.constructor) !== u4 && (null === (n10 = null == r4 ? void 0 : r4._$AO) || void 0 === n10 || n10.call(r4, false), void 0 === u4 ? r4 = void 0 : (r4 = new u4(t5), r4._$AT(t5, s7, e12)), void 0 !== e12 ? (null !== (l8 = (h3 = s7)._$Co) && void 0 !== l8 ? l8 : h3._$Co = [])[e12] = r4 : s7._$Cl = r4), void 0 !== r4 && (i8 = S2(t5, r4._$AS(t5, i8.values), r4, e12)), i8;
}
var M = class {
  constructor(t5, i8) {
  ...
  u(t5) {
    var i8;
    const { el: { content: s7 }, parts: e12 } = this._$AD, o10 = (null !== (i8 = null == t5 ? void 0 : t5.creationScope) && void 0 !== i8 ? i8 : r3).importNode(s7, true);
    C.currentNode = o10;
    let n10 = C.nextNode(), l8 = 0, h3 = 0, u4 = e12[0];
    for (; void 0 !== u4; ) {
      if (l8 === u4.index) {
        let i9;
        2 === u4.type ? i9 = new R(n10, n10.nextSibling, this, t5) : 1 === u4.type ? i9 = new u4.ctor(n10, u4.name, u4.strings, this, t5) : 6 === u4.type && (i9 = new Z(n10, this, t5)), this._$AV.push(i9), u4 = e12[++h3];
      }
      l8 !== (null == u4 ? void 0 : u4.index) && (n10 = C.nextNode(), l8++);
    }
...
var R = class _R {
  constructor(t5, i8, s7, e12) {
    var o10;
    this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t5, this._$AB = i8, this._$AM = s7, this.options = e12, this._$Cp = null === (o10 = null == e12 ? void 0 : e12.isConnected) || void 0 === o10 || o10;
  }
  get _$AU() {
    var t5, i8;
  ...
  _$AI(t5, i8 = this) {
    t5 = S2(this, t5, i8), d2(t5) ? t5 === A || null == t5 || "" === t5 ? (this._$AH !== A && this._$AR(), this._$AH = A) : t5 !== this._$AH && t5 !== T && this._(t5) : void 0 !== t5._$litType$ ? this.g(t5) : void 0 !== t5.nodeType ? this.$(t5) : v(t5) ? this.T(t5) : this._(t5);
  }
  k(t5) {
  ...
  g(t5) {
    var i8;
    const { values: s7, _$litType$: e12 } = t5, o10 = "number" == typeof e12 ? this._$AC(t5) : (void 0 === e12.el && (e12.el = N.createElement(P(e12.h, e12.h[0]), this.options)), e12);
    if ((null === (i8 = this._$AH) || void 0 === i8 ? void 0 : i8._$AD) === o10) this._$AH.v(s7);
    else {
      const t6 = new M(o10, this), i9 = t6.u(this.options);
      t6.v(s7), this.$(i9), this._$AH = t6;
    }
  }
  _$AC(t5) {
    let i8 = E.get(t5.strings);
    return void 0 === i8 && E.set(t5.strings, i8 = new N(t5)), i8;
  }
  T(t5) {
    c2(this._$AH) || (this._$AH = [], this._$AR());
    const i8 = this._$AH;
    let s7, e12 = 0;
    for (const o10 of t5) e12 === i8.length ? i8.push(s7 = new _R(this.k(u2()), this.k(u2()), this, this.options)) : s7 = i8[e12], s7._$AI(o10), e12++;
    e12 < i8.length && (this._$AR(s7 && s7._$AB.nextSibling, e12), i8.length = e12);
  }
  _$AR(t5 = this._$AA.nextSibling, i8) {
    var s7;
    for (null === (s7 = this._$AP) || void 0 === s7 || s7.call(this, false, true, i8); t5 && t5 !== this._$AB; ) {
...
var k = class {
  constructor(t5, i8, s7, e12, o10) {
    this.type = 1, this._$AH = A, this._$AN = void 0, this.element = t5, this.name = i8, this._$AM = e12, this.options = o10, s7.length > 2 || "" !== s7[0] || "" !== s7[1] ? (this._$AH = Array(s7.length - 1).fill(new String()), this.strings = s7) : this._$AH = A;
  }
  get tagName() {
  ...
  _$AI(t5, i8 = this, s7, e12) {
    const o10 = this.strings;
    let n10 = false;
    if (void 0 === o10) t5 = S2(this, t5, i8, 0), n10 = !d2(t5) || t5 !== this._$AH && t5 !== T, n10 && (this._$AH = t5);
    else {
      const e13 = t5;
      let l8, h3;
      for (t5 = o10[0], l8 = 0; l8 < o10.length - 1; l8++) h3 = S2(this, e13[s7 + l8], i8, l8), h3 === T && (h3 = this._$AH[l8]), n10 || (n10 = !d2(h3) || h3 !== this._$AH[l8]), h3 === A ? t5 = A : t5 !== A && (t5 += (null != h3 ? h3 : "") + o10[l8 + 1]), this._$AH[l8] = h3;
    }
    n10 && !e12 && this.j(t5);
  }
  j(t5) {
...
var z = class extends k {
  constructor(t5, i8, s7, e12, o10) {
    super(t5, i8, s7, e12, o10), this.type = 5;
  }
  _$AI(t5, i8 = this) {
    var s7;
    if ((t5 = null !== (s7 = S2(this, t5, i8, 0)) && void 0 !== s7 ? s7 : A) === T) return;
    const e12 = this._$AH, o10 = t5 === A && e12 !== A || t5.capture !== e12.capture || t5.once !== e12.once || t5.passive !== e12.passive, n10 = t5 !== A && (e12 === A || o10);
    o10 && this.element.removeEventListener(this.name, this, e12), n10 && this.element.addEventListener(this.name, this, t5), this._$AH = t5;
  }
  handleEvent(t5) {
    var i8, s7;
    "function" == typeof this._$AH ? this._$AH.call(null !== (s7 = null === (i8 = this.options) || void 0 === i8 ? void 0 : i8.host) && void 0 !== s7 ? s7 : this.element, t5) : this._$AH.handleEvent(t5);
  }
};
var Z = class {
...
var s4 = class extends u {
  ...
  createRenderRoot() {
    ...
    return null !== (t5 = (e12 = this.renderOptions).renderBefore) && void 0 !== t5 || (e12.renderBefore = i8.firstChild), i8;
  }
  update(t5) {
    const i8 = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t5), this._$Do = D(i8, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t5;
...
// elevation/internal/elevation-styles.cssresult.js
...
`;
var elevation_styles_cssresult_default = styles.styleSheet;
...
// focus/internal/focus-ring-styles.cssresult.js
...
`;
var focus_ring_styles_cssresult_default = styles2.styleSheet;
...
var e9 = (t5) => (...e12) => ({ _$litDirective$: t5, values: e12 });
var i5 = class {
  constructor(t5) {
  }
  get _$AU() {
  ...
  _$AT(t5, e12, i8) {
    this._$Ct = t5, this._$AM = e12, this._$Ci = i8;
  }
  _$AS(t5, e12) {
...
var o8 = e9(class extends i5 {
  constructor(t5) {
    var i8;
    if (super(t5), t5.type !== t4.ATTRIBUTE || "class" !== t5.name || (null === (i8 = t5.strings) || void 0 === i8 ? void 0 : i8.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(t5) {
  ...
  update(i8, [s7]) {
    ...
    if (void 0 === this.it) {
      ...
      for (const t5 in s7) s7[t5] && !(null === (r4 = this.nt) || void 0 === r4 ? void 0 : r4.has(t5)) && this.it.add(t5);
      return this.render(s7);
    }
    const e12 = i8.element.classList;
    this.it.forEach((t5) => {
      t5 in s7 || (e12.remove(t5), this.it.delete(t5));
    });
    for (const t5 in s7) {
      const i9 = !!s7[t5];
      i9 === this.it.has(t5) || (null === (o10 = this.nt) || void 0 === o10 ? void 0 : o10.has(t5)) || (i9 ? (e12.add(t5), this.it.add(t5)) : (e12.remove(t5), this.it.delete(t5)));
    }
    return T;
  }
});
...
var Ripple = class extends s4 {
  ...
  render() {
    ...
    return x`<div class="surface ${o8(classes)}"></div>`;
  }
  update(changedProps) {
...
// ripple/internal/ripple-styles.cssresult.js
...
`;
var ripple_styles_cssresult_default = styles3.styleSheet;
...
// internal/events/dispatch-hooks.js
...
// labs/behaviors/form-submitter.js
...
var buttonBaseClass = mixinDelegatesAria(mixinFormSubmitter(mixinFormAssociated(mixinElementInternals(s4))));
...
// button/internal/elevated-styles.cssresult.js
...
`;
var elevated_styles_cssresult_default = styles4.styleSheet;

// button/internal/shared-elevation-styles.cssresult.js
var styles5 = i3`md-elevation{transition-duration:280ms}:host(:is([disabled],[soft-disabled])) md-elevation{transition:none}md-elevation{--md-elevation-level: var(--_container-elevation);--md-elevation-shadow-color: var(--_container-shadow-color)}:host(:focus-within) md-elevation{--md-elevation-level: var(--_focus-container-elevation)}:host(:hover) md-elevation{--md-elevation-level: var(--_hover-container-elevation)}:host(:active) md-elevation{--md-elevation-level: var(--_pressed-container-elevation)}:host(:is([disabled],[soft-disabled])) md-elevation{--md-elevation-level: var(--_disabled-container-elevation)}
`;
var shared_elevation_styles_cssresult_default = styles5.styleSheet;

// button/internal/shared-styles.cssresult.js
...
`;
var shared_styles_cssresult_default = styles6.styleSheet;
...
// button/internal/filled-styles.cssresult.js
...
`;
var filled_styles_cssresult_default = styles7.styleSheet;
...
// button/internal/filled-tonal-styles.cssresult.js
...
`;
var filled_tonal_styles_cssresult_default = styles8.styleSheet;
...
// button/internal/outlined-styles.cssresult.js
...
`;
var outlined_styles_cssresult_default = styles9.styleSheet;
...
// button/internal/text-styles.cssresult.js
...
`;
var text_styles_cssresult_default = styles10.styleSheet;
...
var checkboxBaseClass = mixinDelegatesAria(mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(s4))));
...
// checkbox/internal/checkbox-styles.cssresult.js
...
`;
var checkbox_styles_cssresult_default = styles11.styleSheet;
...
var chipBaseClass = mixinDelegatesAria(s4);
...
// chips/internal/assist-styles.cssresult.js
...
`;
var assist_styles_cssresult_default = styles12.styleSheet;

// chips/internal/elevated-styles.cssresult.js
...
`;
var elevated_styles_cssresult_default2 = styles13.styleSheet;

// chips/internal/shared-styles.cssresult.js
...
`;
var shared_styles_cssresult_default2 = styles14.styleSheet;
...
// chips/internal/chip-set-styles.cssresult.js
var styles15 = i3`:host{display:flex;flex-wrap:wrap;gap:8px}
`;
var chip_set_styles_cssresult_default = styles15.styleSheet;
...
// chips/internal/filter-styles.cssresult.js
...
`;
var filter_styles_cssresult_default = styles16.styleSheet;

// chips/internal/selectable-styles.cssresult.js
...
`;
var selectable_styles_cssresult_default = styles17.styleSheet;

// chips/internal/trailing-icon-styles.cssresult.js
...
`;
var trailing_icon_styles_cssresult_default = styles18.styleSheet;
...
// chips/internal/input-styles.cssresult.js
...
`;
var input_styles_cssresult_default = styles19.styleSheet;
...
// chips/internal/suggestion-styles.cssresult.js
...
`;
var suggestion_styles_cssresult_default = styles20.styleSheet;
...
// divider/internal/divider-styles.cssresult.js
...
`;
var divider_styles_cssresult_default = styles21.styleSheet;
...
var dialogBaseClass = mixinDelegatesAria(s4);
...
// dialog/internal/dialog-styles.cssresult.js
...
`;
var dialog_styles_cssresult_default = styles22.styleSheet;
...
var fabBaseClass = mixinDelegatesAria(s4);
...
// fab/internal/fab-branded-styles.cssresult.js
...
`;
var fab_branded_styles_cssresult_default = styles23.styleSheet;

// fab/internal/forced-colors-styles.cssresult.js
...
`;
var forced_colors_styles_cssresult_default = styles24.styleSheet;

// fab/internal/shared-styles.cssresult.js
...
`;
var shared_styles_cssresult_default3 = styles25.styleSheet;
...
// fab/internal/fab-styles.cssresult.js
...
`;
var fab_styles_cssresult_default = styles26.styleSheet;
...
// field/internal/filled-styles.cssresult.js
...
`;
var filled_styles_cssresult_default2 = styles27.styleSheet;

// field/internal/shared-styles.cssresult.js
...
`;
var shared_styles_cssresult_default4 = styles28.styleSheet;
...
// field/internal/outlined-styles.cssresult.js
...
`;
var outlined_styles_cssresult_default2 = styles29.styleSheet;
...
// icon/internal/icon-styles.cssresult.js
...
`;
var icon_styles_cssresult_default = styles30.styleSheet;
...
// iconbutton/internal/filled-styles.cssresult.js
...
`;
var filled_styles_cssresult_default3 = styles31.styleSheet;

// node_modules/lit-html/static.js
var e10 = Symbol.for("");
var l5 = (t5) => {
  if ((null == t5 ? void 0 : t5.r) === e10) return null == t5 ? void 0 : t5._$litStatic$;
};
var i6 = (t5, ...r4) => ({ _$litStatic$: r4.reduce((r5, e12, l8) => r5 + ((t6) => {
...
})(e12) + t5[l8 + 1], t5[0]), r: e10 });
var s5 = /* @__PURE__ */ new Map();
var a3 = (t5) => (r4, ...e12) => {
  const o10 = e12.length;
  let i8, a5;
  const n10 = [], u4 = [];
  let c3, $2 = 0, f2 = false;
  for (; $2 < o10; ) {
    for (c3 = r4[$2]; $2 < o10 && void 0 !== (a5 = e12[$2], i8 = l5(a5)); ) c3 += i8 + r4[++$2], f2 = true;
    $2 !== o10 && u4.push(a5), n10.push(c3), $2++;
  }
  if ($2 === o10 && n10.push(r4[o10]), f2) {
    const t6 = n10.join("$$lit$$");
    void 0 === (r4 = s5.get(t6)) && (n10.raw = n10, s5.set(t6, r4 = n10)), e12 = u4;
  }
  return t5(r4, ...e12);
};
var n7 = a3(x);
...
var iconButtonBaseClass = mixinDelegatesAria(mixinFormSubmitter(mixinFormAssociated(mixinElementInternals(s4))));
...
// iconbutton/internal/shared-styles.cssresult.js
var styles32 = i3`:host{display:inline-flex;outline:none;-webkit-tap-highlight-color:rgba(0,0,0,0);height:var(--_container-height);width:var(--_container-width);justify-content:center}:host([touch-target=wrapper]){margin:max(0px,(48px - var(--_container-height))/2) max(0px,(48px - var(--_container-width))/2)}md-focus-ring{--md-focus-ring-shape-start-start: var(--_container-shape-start-start);--md-focus-ring-shape-start-end: var(--_container-shape-start-end);--md-focus-ring-shape-end-end: var(--_container-shape-end-end);--md-focus-ring-shape-end-start: var(--_container-shape-end-start)}:host(:is([disabled],[soft-disabled])){pointer-events:none}.icon-button{place-items:center;background:none;border:none;box-sizing:border-box;cursor:pointer;display:flex;place-content:center;outline:none;padding:0;position:relative;text-decoration:none;user-select:none;z-index:0;flex:1;border-start-start-radius:var(--_container-shape-start-start);border-start-end-radius:var(--_container-shape-start-end);border-end-start-radius:var(--_container-shape-end-start);border-end-end-radius:var(--_container-shape-end-end)}.icon ::slotted(*){font-size:var(--_icon-size);height:var(--_icon-size);width:var(--_icon-size);font-weight:inherit}md-ripple{z-index:-1;border-start-start-radius:var(--_container-shape-start-start);border-start-end-radius:var(--_container-shape-start-end);border-end-start-radius:var(--_container-shape-end-start);border-end-end-radius:var(--_container-shape-end-end)}.flip-icon .icon{transform:scaleX(-1)}.icon{display:inline-flex}.link{display:grid;height:100%;outline:none;place-items:center;position:absolute;width:100%}.touch{position:absolute;height:max(48px,100%);width:max(48px,100%)}:host([touch-target=none]) .touch{display:none}@media(forced-colors: active){:host(:is([disabled],[soft-disabled])){--_disabled-icon-color: GrayText;--_disabled-icon-opacity: 1}}
`;
var shared_styles_cssresult_default5 = styles32.styleSheet;
...
// iconbutton/internal/filled-tonal-styles.cssresult.js
...
`;
var filled_tonal_styles_cssresult_default2 = styles33.styleSheet;
...
// iconbutton/internal/standard-styles.cssresult.js
...
`;
var standard_styles_cssresult_default = styles34.styleSheet;
...
// iconbutton/internal/outlined-styles.cssresult.js
...
`;
var outlined_styles_cssresult_default3 = styles35.styleSheet;
...
// list/internal/list-styles.cssresult.js
...
`;
var list_styles_cssresult_default = styles36.styleSheet;
...
// labs/item/internal/item-styles.cssresult.js
...
`;
var item_styles_cssresult_default = styles37.styleSheet;
...
var listItemBaseClass = mixinDelegatesAria(s4);
var ListItemEl = class extends listItemBaseClass {
  ...
  onFocusRingVisibilityChanged(e12) {
  }
  /**
...
var i7 = "important";
var n8 = " !" + i7;
var o9 = e9(class extends i5 {
  constructor(t5) {
    var e12;
    if (super(t5), t5.type !== t4.ATTRIBUTE || "style" !== t5.name || (null === (e12 = t5.strings) || void 0 === e12 ? void 0 : e12.length) > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
  }
  render(t5) {
    return Object.keys(t5).reduce((e12, r4) => {
      const s7 = t5[r4];
      return null == s7 ? e12 : e12 + `${r4 = r4.includes("-") ? r4 : r4.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g, "-$&").toLowerCase()}:${s7};`;
    }, "");
  }
  update(e12, [r4]) {
    const { style: s7 } = e12.element;
    if (void 0 === this.ht) {
      this.ht = /* @__PURE__ */ new Set();
      for (const t5 in r4) this.ht.add(t5);
      return this.render(r4);
    }
    this.ht.forEach((t5) => {
      null == r4[t5] && (this.ht.delete(t5), t5.includes("-") ? s7.removeProperty(t5) : s7[t5] = "");
    });
    for (const t5 in r4) {
      const e13 = r4[t5];
      if (null != e13) {
        this.ht.add(t5);
        const r5 = "string" == typeof e13 && e13.endsWith(n8);
        t5.includes("-") || r5 ? s7.setProperty(t5, r5 ? e13.slice(0, -11) : e13, r5 ? i7 : "") : s7[t5] = e13;
      }
    }
    return T;
  }
...
var TypeaheadController = class {
  ...
  typeahead(event) {
    ...
    const matchingRecords = this.typeaheadRecords.filter((record) => !record[TYPEAHEAD_RECORD.ITEM].disabled && record[TYPEAHEAD_RECORD.TEXT].startsWith(this.typaheadBuffer)).sort((a5, b2) => rebaseIndexOnActive(a5) - rebaseIndexOnActive(b2));
...
// menu/internal/menu-styles.cssresult.js
...
`;
var menu_styles_cssresult_default = styles39.styleSheet;
...
var menuItemBaseClass = mixinDelegatesAria(s4);
...
// menu/internal/submenu/sub-menu-styles.cssresult.js
var styles41 = i3`:host{position:relative;display:flex;flex-direction:column}
`;
var sub_menu_styles_cssresult_default = styles41.styleSheet;
...
var progressBaseClass = mixinDelegatesAria(s4);
...
// progress/internal/circular-progress-styles.cssresult.js
...
`;
var circular_progress_styles_cssresult_default = styles42.styleSheet;
...
// progress/internal/linear-progress-styles.cssresult.js
...
`;
var linear_progress_styles_cssresult_default = styles43.styleSheet;
...
var maskId = 0;
var radioBaseClass = mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(mixinFocusable(s4))));
...
// radio/internal/radio-styles.cssresult.js
...
`;
var radio_styles_cssresult_default = styles44.styleSheet;
...
var selectBaseClass = mixinDelegatesAria(mixinOnReportValidity(mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(s4)))));
var Select = class extends selectBaseClass {
   ...
   * active items.
   */
  async handleOpening(e12) {
    this.labelEl?.removeAttribute?.("aria-live");
    this.redispatchEvent(e12);
...
// select/internal/filled-select-styles.cssresult.js
...
`;
var filled_select_styles_cssresult_default = styles45.styleSheet;

// select/internal/shared-styles.cssresult.js
...
`;
var shared_styles_cssresult_default6 = styles46.styleSheet;
...
// select/internal/outlined-select-styles.cssresult.js
...
`;
var outlined_select_styles_cssresult_default = styles47.styleSheet;
...
var SelectOptionController = class {
  ...
  constructor(host, config) {
    ...
    this.onKeydown = (e12) => {
      this.menuItemController.onKeydown(e12);
    };
...
var selectOptionBaseClass = mixinDelegatesAria(s4);
...
// slider/internal/forced-colors-styles.cssresult.js
...
`;
var forced_colors_styles_cssresult_default2 = styles48.styleSheet;

// node_modules/lit-html/directives/when.js
function n9(n10, o10, r4) {
  return n10 ? o10() : null == r4 ? void 0 : r4();
}

// slider/internal/slider.js
var sliderBaseClass = mixinDelegatesAria(mixinFormAssociated(mixinElementInternals(s4)));
...
function isOverlapping(elA, elB) {
  ...
  return !(a5.top > b2.bottom || a5.right < b2.left || a5.bottom < b2.top || a5.left > b2.right);
}

// slider/internal/slider-styles.cssresult.js
...
`;
var slider_styles_cssresult_default = styles49.styleSheet;
...
var switchBaseClass = mixinDelegatesAria(mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(s4))));
...
// switch/internal/switch-styles.cssresult.js
...
`;
var switch_styles_cssresult_default = styles50.styleSheet;
...
var tabBaseClass = mixinFocusable(s4);
var Tab = class extends tabBaseClass {
  ...
  [ANIMATE_INDICATOR](previousTab) {
    ...
    this.indicator.getAnimations().forEach((a5) => {
      a5.cancel();
    });
...
// tabs/internal/primary-tab-styles.cssresult.js
...
`;
var primary_tab_styles_cssresult_default = styles51.styleSheet;

// tabs/internal/tab-styles.cssresult.js
...
`;
var tab_styles_cssresult_default = styles52.styleSheet;
...
// tabs/internal/secondary-tab-styles.cssresult.js
...
`;
var secondary_tab_styles_cssresult_default = styles53.styleSheet;
...
var Tabs = class extends s4 {
  ...
  async scrollToTab(tabToScrollTo) {
    await this.updateComplete;
    const { tabs: tabs2 } = this;
    tabToScrollTo ??= this.activeTab;
    if (!tabToScrollTo || !tabs2.includes(tabToScrollTo) || !this.tabsScrollerElement) {
      return;
    }
  ...
  activateTab(activeTab) {
    ...
    if (!tabs2.includes(activeTab) || previousTab === activeTab) {
      return;
    }
  ...
  async handleKeydown(event) {
    ...
    let indexToFocus;
    if (isHome || isEnd) {
      indexToFocus = isHome ? 0 : tabs2.length - 1;
    } else {
      const isRtl2 = getComputedStyle(this).direction === "rtl";
      const forwards = isRtl2 ? isLeft : isRight;
      const { focusedTab } = this;
      if (!focusedTab) {
        indexToFocus = forwards ? 0 : tabs2.length - 1;
      } else {
        const focusedIndex = this.tabs.indexOf(focusedTab);
        indexToFocus = forwards ? focusedIndex + 1 : focusedIndex - 1;
        if (indexToFocus >= tabs2.length) {
          indexToFocus = 0;
        } else if (indexToFocus < 0) {
          indexToFocus = tabs2.length - 1;
        }
      }
    }
    const tabToFocus = tabs2[indexToFocus];
    tabToFocus.focus();
...
// tabs/internal/tabs-styles.cssresult.js
...
`;
var tabs_styles_cssresult_default = styles54.styleSheet;
...
// textfield/internal/filled-styles.cssresult.js
...
`;
var filled_styles_cssresult_default4 = styles55.styleSheet;

// node_modules/lit-html/directive-helpers.js
var { I: l6 } = j;
var e11 = (o10) => void 0 === o10.strings;
var s6 = {};
var a4 = (o10, l8 = s6) => o10._$AH = l8;

// node_modules/lit-html/directives/live.js
var l7 = e9(class extends i5 {
  constructor(r4) {
    if (super(r4), r4.type !== t4.PROPERTY && r4.type !== t4.ATTRIBUTE && r4.type !== t4.BOOLEAN_ATTRIBUTE) throw Error("The `live` directive is not allowed on child or event bindings");
    if (!e11(r4)) throw Error("`live` bindings can only contain a single expression");
  }
  render(r4) {
    return r4;
  }
  update(i8, [t5]) {
    ...
    const o10 = i8.element, l8 = i8.name;
    if (i8.type === t4.PROPERTY) {
      if (t5 === o10[l8]) return T;
    } else if (i8.type === t4.BOOLEAN_ATTRIBUTE) {
      if (!!t5 === o10.hasAttribute(l8)) return T;
    } else if (i8.type === t4.ATTRIBUTE && o10.getAttribute(l8) === t5 + "") return T;
    return a4(i8), t5;
  }
});
...
var textFieldBaseClass = mixinDelegatesAria(mixinOnReportValidity(mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(s4)))));
var TextField = class extends textFieldBaseClass {
  ...
  renderAffix(text, isSuffix) {
    ...
    return x`<span class="${o8(classes)}">${text}</span>`;
  }
  getErrorText() {
    return this.error ? this.errorText : this.nativeErrorText;
  }
...
// textfield/internal/shared-styles.cssresult.js
var styles56 = i3`:host{display:inline-flex;outline:none;resize:both;text-align:start;-webkit-tap-highlight-color:rgba(0,0,0,0)}.text-field,.field{width:100%}.text-field{display:inline-flex}.field{cursor:text}.disabled .field{cursor:default}.text-field,.textarea .field{resize:inherit}slot[name=container]{border-radius:inherit}.icon{color:currentColor;display:flex;align-items:center;justify-content:center;fill:currentColor;position:relative}.icon ::slotted(*){display:flex;position:absolute}[has-start] .icon.leading{font-size:var(--_leading-icon-size);height:var(--_leading-icon-size);width:var(--_leading-icon-size)}[has-end] .icon.trailing{font-size:var(--_trailing-icon-size);height:var(--_trailing-icon-size);width:var(--_trailing-icon-size)}.input-wrapper{display:flex}.input-wrapper>*{all:inherit;padding:0}.input{caret-color:var(--_caret-color);overflow-x:hidden;text-align:inherit}.input::placeholder{color:currentColor;opacity:1}.input::-webkit-calendar-picker-indicator{display:none}.input::-webkit-search-decoration,.input::-webkit-search-cancel-button{display:none}@media(forced-colors: active){.input{background:none}}.no-spinner .input::-webkit-inner-spin-button,.no-spinner .input::-webkit-outer-spin-button{display:none}.no-spinner .input[type=number]{-moz-appearance:textfield}:focus-within .input{caret-color:var(--_focus-caret-color)}.error:focus-within .input{caret-color:var(--_error-focus-caret-color)}.text-field:not(.disabled) .prefix{color:var(--_input-text-prefix-color)}.text-field:not(.disabled) .suffix{color:var(--_input-text-suffix-color)}.text-field:not(.disabled) .input::placeholder{color:var(--_input-text-placeholder-color)}.prefix,.suffix{text-wrap:nowrap;width:min-content}.prefix{padding-inline-end:var(--_input-text-prefix-trailing-space)}.suffix{padding-inline-start:var(--_input-text-suffix-leading-space)}
`;
var shared_styles_cssresult_default7 = styles56.styleSheet;
...
// textfield/internal/outlined-styles.cssresult.js
...
`;
var outlined_styles_cssresult_default4 = styles57.styleSheet;
